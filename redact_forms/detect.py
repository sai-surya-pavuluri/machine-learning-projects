...
from redact import start_monitoring_redactions_folder  # Updated import

# Paths
WATCH_FOLDER = "C:\\Users\\spavuluri\\OneDrive - Datapac Ltd\\Documents\\Test"
OUTPUT_FOLDER = "C:\\Users\\spavuluri\\OneDrive - Datapac Ltd\\Documents\\detections"
LABELS_FOLDER = os.path.join(OUTPUT_FOLDER, "labels")
REDACT_FOLDER = "C:\\Users\\spavuluri\\OneDrive - Datapac Ltd\\Documents\\redactions"

# Ensure output directories exist
os.makedirs(OUTPUT_FOLDER, exist_ok=True)
os.makedirs(LABELS_FOLDER, exist_ok=True)
os.makedirs(REDACT_FOLDER, exist_ok=True)
...
weights = "runs/train/exp49/weights/best.pt"  # Path to weights file
...
def start_monitoring_detections_folder():
    ...
    redaction_thread = threading.Thread(
        ...
        args=(OUTPUT_FOLDER, LABELS_FOLDER, REDACT_FOLDER, stop_event)
    )
